    ...
    for (let i = 0; i < data.results.length; i++) {
      ...
      await prisma.s2023Average.create({
        data: {
          ...
          field_percent: parseFloat(data.results[i].field_percent).toString(),
          ...
          three_percent: parseFloat(data.results[i].three_percent).toString(),
          ...
          two_percent: parseFloat(data.results[i].two_percent).toString(),
          ft: parseFloat((data.results[i].ft / gamesPlayed).toFixed(1)),
          fta: parseFloat((data.results[i].fta / gamesPlayed).toFixed(1)),
          ft_percent: parseFloat(data.results[i].ft_percent).toString(),
